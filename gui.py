...
class PixelCatGUI:
  ...
  |||
    ...
    def calculate_text_size(self, text, wrap_width=400):
        ...
        chars_per_line_estimate = wrap_width // 8
        ...
        for line in lines:
            if len(line) == 0:
                ...
                line_count = max(1, (len(line) + chars_per_line_estimate - 1) // chars_per_line_estimate)
                total_lines += line_count

        estimated_height = max(70, total_lines * font_height_approx + 50)
    ...
    def add_user_bubble(self, message):
        ...
        with dpg.group(parent="chat_history", horizontal=True):
            ...
            # Bind the theme directly to the child window using its tag
            dpg.bind_item_theme(user_bubble_tag, self.user_bubble_theme)
    ...
    def add_bot_bubble(self, message):
        ...
        with dpg.group(parent="chat_history", horizontal=True):
            ...
            # Bind the theme directly to the child window using its tag
            dpg.bind_item_theme(bot_bubble_tag, self.bot_bubble_theme)
    ...
    def add_greetings_bubble(self, message):
        ...
        with dpg.group(parent="chat_history", horizontal=True):
            ...
            # Bind the theme directly to the child window using its tag
            dpg.bind_item_theme(greetings_bubble_tag, self.bot_bubble_theme)
    ...
    def add_system_bubble(self, message):
        ...
        with dpg.group(parent="chat_history", horizontal=True):
            ...
            # Bind the theme directly to the child window using its tag
            dpg.bind_item_theme(system_bubble_tag, self.system_bubble_theme)
